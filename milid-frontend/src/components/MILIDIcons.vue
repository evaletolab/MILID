<template>
  ...
  <!--- podcast -->
  <svg v-else-if="name === 'podcast'" :viewBox="viewBox" preserveAspectRatio="none" >
    <g>
  ...
  <svg v-else-if="name === 'user'" viewBox="0 0 65.59 68.23" preserveAspectRatio="none" >
    <path class="op5" d="M21.81,64.47c8.59,4.45,24.03,6.12,29.82-1.63C65.85,43.83,67.99,0,38.81,0C-13,0-6.83,49.63,21.81,64.47z"/>
...
export default class MILIDIcons extends Vue {
  ...
  async created() {
    this.config = await $config.store.config;
