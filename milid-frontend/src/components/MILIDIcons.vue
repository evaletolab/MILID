<template>
  ...
  <svg v-else-if="name === 'sources-bar'" viewBox="0 0 78.230522 100.00403" preserveAspectRatio="none" >
    <path :style="{ fill: colorPrimary }" 
          d="m 42.460522,86.764026 c 0,-4.65 3.05,-8.77 7.51,-10.06 16.32,-4.71 28.26,-19.75 28.26,-37.59 0,-21.79 -17.81,-39.41999951 -39.67,-39.10999951 -21.37,0.3 -38.67000033,17.95999951 -38.5600003265,39.32999951 0.0999999965,17.75 12.0200003265,32.7 28.2800003265,37.38 4.45,1.28 7.48,5.41 7.48,10.05 v 0 c 0,7.31 -5.93,13.240004 -13.24,13.240004 h 33.18 c -7.31,0 -13.24,-5.930004 -13.24,-13.240004 z m -24.91,-23.57 c -7.6000003,-6.83 -11.4800003,-16.58 -10.6400003,-26.82 0.54,-6.62 3.1500003,-12.94 7.4300003,-18.02 4.58,-5.43 10.59,-9.0899995 17.22,-10.6699995 V 49.304026 c 0,2.76 3.39,4.07 5.25,2.04 l 9.1,-9.96 9.1,9.96 c 1.86,2.04 5.25,0.72 5.25,-2.04 v -34.62 c 0.58,0.51 1.16,1.03 1.71,1.58 6.5,6.5 9.89,15.27 9.42,24.52 -0.37,7.37 -3.28,14.44 -8.22,19.92 -6.61,7.34 -15.94,11.21 -25.81,10.69 -7.33,-0.39 -14.35,-3.29 -19.81,-8.2 z"/>
  ...
  <!-- LOGO -->
  <svg v-else-if="name === 'logo'" @click="$emit('wasClicked')" :width="width" viewBox="0 0 274 106" preserveAspectRatio="none">
    <g>
      <path :style="{ fill: color }" d="M219.6,96.95h-18.97c-3.46,0-6.28-2.82-6.28-6.28V32.02c0-3.46,2.82-6.28,6.28-6.28h18.97c12.22,0,21.85,2.55,28.62,7.58
        ...
        "/>
      <g>
        <path :style="{ fill: color }" d="M175.1,36.72c-7.61,0-13.81-6.21-13.81-13.84s6.19-13.84,13.81-13.84s13.81,6.21,13.81,13.84S182.71,36.72,175.1,36.72z
      ...
      <g>
        <path :style="{ fill: color }" d="M111.96,36.72c-7.61,0-13.81-6.21-13.81-13.84s6.19-13.84,13.81-13.84s13.81,6.21,13.81,13.84S119.57,36.72,111.96,36.72z
      ...
      <g>
        <path :style="{ fill: color }" d="M44.1,95.92l-13.3-45.56v45.56H13.69V29.72h27.87l11.2,41.18l11.02-41.18h27.59v66.19H74.25V50.08L61.13,95.92H44.1z"/>
      </g>
      <g>
        <path :style="{ fill: color }" d="M121.45,95.92h-18.98V45.3h18.98V95.92z"/>
      </g>
      <g>
        <path :style="{ fill: color }" d="M153.01,77.41L153.01,77.41v18.5h-19.03V21.4h19.03V77.41z"/>
      </g>
      <path :style="{ fill: color }" d="M180.92,96.66h-11.65c-3.25,0-5.89-2.55-5.89-5.68v-40.7c0-3.13,2.64-5.68,5.89-5.68h11.65c3.25,0,5.89,2.55,5.89,5.68
